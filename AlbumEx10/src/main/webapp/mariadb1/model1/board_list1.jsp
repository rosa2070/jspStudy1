...
<%
	...
	try {
		...
		String sql = "select seq, subject, cmtcnt, writer, imagename, imagesize, date_format(wdate, '%Y.%m.%d') wdate, hit, datediff(now(), wdate) wgap from album_cmt_board1 order by seq desc";
