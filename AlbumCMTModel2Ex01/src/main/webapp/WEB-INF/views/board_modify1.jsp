...
<div class="contents1"> 
	...
	<form action="./board_modify_ok.do" method="post" name="mfrm" enctype="multipart/form-data">
		...
		<div class="contents_sub">	
			...
			<div class="btn_area">
				<div class="align_left">
					...
					<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='./board_view.do?cpage=<%=cpage %>&seq=<%=seq %>'" />
				</div>
